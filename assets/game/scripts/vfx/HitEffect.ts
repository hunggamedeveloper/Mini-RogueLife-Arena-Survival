// ============================================================
// HitEffect.ts — Poolable VFX that plays its Animation clip
// then auto-returns to pool when finished.
// Attach to HitEffect prefab alongside Animation component.
// ============================================================
...
@ccclass('HitEffect')
export class HitEffect extends Component implements IPoolable {
    ...
    private _onAnimFinished(): void {
        PoolManager.instance?.put('hitEffect', this);
    }
}
